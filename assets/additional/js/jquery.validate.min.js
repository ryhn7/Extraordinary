! function (t) {
    ...
    d.extend(d.expr.pseudos || d.expr[":"], {
        ...
        prototype: {
            init: function () {
                function t(t) {
                    var e, i, s, n = void 0 !== d(this).attr("contenteditable") && "false" !== d(this).attr("contenteditable");
                    !this.form && n && (this.form = d(this).closest("form")[0], this.name = d(this).attr("name")), r === this.form && (e = d.data(this.form, "validator"), i = "on" + t.type.replace(/^validate/, ""), (s = e.settings)[i] && !d(this).is(s.ignore) && s[i].call(e, this, t))
                }
